    ...
    <div className="absolute inset-0 w-full h-full overflow-y-auto z-40 bg-black">
      <div className="max-w-4xl mx-auto px-5 sm:px-10 pt-28 sm:pt-40 pb-24 sm:pb-20 pointer-events-auto">
        ...
        >
          ...
          <p className="font-serif text-base sm:text-lg md:text-xl leading-relaxed text-[#c8c4c0] mb-8 max-w-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-8">
            <Link to="/project/obs-001-concrete" className="block group">
              <div className="aspect-[4/5] bg-[#1a1715] border border-[rgba(255,255,255,0.05)] relative overflow-hidden flex flex-col justify-end group-hover:shadow-[0_0_30px_rgba(255,255,255,0.03)] transition-all">
                ...
                <h3 className="font-mono text-xs tracking-widest text-[#e6e0d8] relative z-10 p-4 sm:p-6">OBS-001 CONCRETE</h3>
              </div>
            </Link>
            <Link to="/project/obs-002-glass" className="block group">
              <div className="aspect-[4/5] bg-[#1a1715] border border-[rgba(255,255,255,0.05)] relative overflow-hidden flex flex-col justify-end group-hover:shadow-[0_0_30px_rgba(255,255,255,0.03)] transition-all">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent pointer-events-none" />
                <h3 className="font-mono text-xs tracking-widest text-[#e6e0d8] relative z-10 p-4 sm:p-6">OBS-002 GLASS</h3>
              </div>
            </Link>
          </div>
        </motion.div>
