        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 mt-8 sm:mt-12">
            <div>
              ...
              <p className="font-serif text-stone-600 dark:text-[#a0a0a0] leading-relaxed">
            ...
            <div className="aspect-square bg-stone-200 dark:bg-[#1a1715] border border-stone-300 dark:border-[rgba(255,255,255,0.05)] relative overflow-hidden">
